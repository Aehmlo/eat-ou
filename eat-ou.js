...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_475aa7911d99b856d18bc9d93f704d059f0a00a0": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). getDay ();})());
            },
            "__extjs_80d6d56760c65e49b7be8b6b01c1ea861b046bf0": function($0) {
                Module.STDWEB_PRIVATE.decrement_refcount( $0 );
            },
            "__extjs_e070d91046dded2a39d1e3343a42ead253ef848e": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){document.getElementById ("next"). addEventListener ("click" , ($1), {once : true});})());
            },
            ...
            "__extjs_7ba2c6ed9b5a5d6e153bbdf9a5bf235691ee55ed": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){($1). style.display = "block" ;})());
            },
            ...
            "__extjs_362b540dcdd19fb34f830084ef1d2eac87967133": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){document.getElementById ("next"). style.display = "initial" ; document.getElementById ("list"). style.display = "initial" ;})());
            },
            "__extjs_b55887804cbece1d2b44e46f3050b683385bd263": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). getHours ();})());
            },
            "__extjs_1cc7e515dd2737154bce46370456abc28b2f848c": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){document.getElementById ("next"). click ();})());
            },
            ...
            "__extjs_b0c667c83d617c33401401c07dfca16c60518ad2": function($0, $1) {
            ...
            "__extjs_9f4dbe026662ddf351eb444034fa07379c03adbe": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){($1). style.display = "none" ;})());
            },
            ...
            "__extjs_98727bdec6115290bbee0bdfa7b405667a197d66": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){document.getElementById ("list"). click ();})());
            },
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'eat_ou'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'eat_ou':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" && typeof process === "object" ) {
        ...
        const wasm_path = path.join( __dirname, "eat-ou.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "eat-ou.wasm" )
